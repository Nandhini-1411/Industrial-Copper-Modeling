...
status_encoded = {'Draft': 0, 'Lost': 1, 'Not lost for AM': 2, 'Offerable': 3, 'Offered': 4, 
                  'Revised': 5, 'To be approved': 6, 'Won': 7, 'Wonderful': 8}
...
def predict_status(country, item_type, order_day, order_month, order_year, 
                   delivery_year, delivery_month, delivery_day, application, 
                   width, product_ref, thickness_boxcox, quantity_tons_boxcox, selling_price):
    ...
    user_data = np.array([[country, item_type_encoded_value, order_year, order_month, order_day, 
                            delivery_year, delivery_month, delivery_day, application, width, 
                            product_ref, thickness_boxcox, quantity_tons_boxcox, selling_price]])
    
    y_pred = model.predict(user_data)
    return y_pred[0]

# Predict Selling Price Function
def predict_selling_price(country, status, item_type, order_day, order_month, order_year, 
                          delivery_year, delivery_month, delivery_day, application, 
...
if option == "PREDICT SELLING PRICE":
    ...
    with col1:
        country = st.selectbox("Enter Country", options=['25', '26', '27', '28', '30', '32', '38', '39', '40', '77', 
                                                         '78', '79', '80', '84', '89', '107', '113'])
        ...
        application = st.selectbox("Enter Application", options=["10.0", "41.0", "15.0", "59.0", "42.0", "56.0", 
                                                                 "29.0", "26.0", "27.0", "28.0", "25.0", "40.0", "79.0",
                                                                 "22.0", "66.0", "20.0", "3.0", "38.0", "58.0", "65.0", 
                                                                 "4.0", "68.0", "39.0", "67.0", "19.0", "99.0", "69.0", 
                                                                 "5.0", "70.0", "2.0"])
    ...
    with col3:
        if st.button("Predict Selling Price"):
            price = predict_selling_price(country, status, item_type, item_date_input.day, item_date_input.month, 
                                          item_date_input.year, delivery_date_input.year, delivery_date_input.month, 
                                          delivery_date_input.day, application, width, product_ref, thickness_boxcox, 
                                          quantity_tons_boxcox)
